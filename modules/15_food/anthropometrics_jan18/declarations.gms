...
* transition to exogenous scenario diets
 ...
 i15_intake_EATLancet_all(t,i,kcal_scen15,EAT_scen15,kfo)       Food-specific per capita calorie intake according to various EAT Lancet diet scenarios (kcal per capita per day)
